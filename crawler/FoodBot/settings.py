...
SOURCE2 = {
    ...
    'recipes': 'http://www.seriouseats.com/topics/search?index=recipe&count=999999&only=tags,ingredients,title,thumbnail_1500,active_time,permalink,total_time,number_serves',
