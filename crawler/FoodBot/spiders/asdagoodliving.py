...
class AsdagoodlivingSpider(scrapy.Spider):
    ...
    def closed(self, reason):
        ...
        try:
            recipes.to_csv(DATA_DIRECTORY+'Source1Recipes.csv', index=False, encoding='utf-8-sig')
            ingredients.to_csv(DATA_DIRECTORY+'Source1Ingredients.csv', index=False, encoding='utf-8-sig')
        except Exception as e:
            raise e
